...
syntax Tbl_table_att
        = 
        String tabstyle? Yesorno tocentry? Yesorno shortentry? ("port" | "land") orient? Yesorno pgwide?
 ;
...
syntax Table_attlist
        = 
        ("top" | "bottom" | "topbot" | "all" | "sides" | "none") frame? Yesorno colsep? Yesorno rowsep? Tbl_table_att Bodyatt Secur
 ;
syntax Tgroup
        = 
...
syntax Tgroup_attlist
        = 
        String cols Tbl_tgroup_att Yesorno colsep? Yesorno rowsep? ("left" | "right" | "center" | "justify" | "char") align? String char? String charoff? Secur
 ;
syntax Colspec
        = 
...
syntax Colspec_attlist
        = 
        String colnum? String colname? String colwidth? Yesorno colsep? Yesorno rowsep? ("left" | "right" | "center" | "justify" | "char") align? String char? String charoff?
 ;
syntax Spanspec
        = 
...
syntax Spanspec_attlist
        = 
        String namest String nameend String spanname Yesorno colsep? Yesorno rowsep? ("left" | "right" | "center" | "justify" | "char") align? String char? String charoff?
 ;
syntax Thead
        = 
...
syntax Thead_attlist
        = 
        ("top" | "middle" | "bottom") valign? Secur
 ;
syntax Tfoot
        = 
...
syntax Row_attlist
        = 
        Yesorno rowsep? ("top" | "middle" | "bottom") valign? Secur
 ;
syntax Entrytbl
        = 
...
syntax Entrytbl_attlist
        = 
        String cols Tbl_tgroup_att String colname? String spanname? String namest? String nameend? Yesorno colsep? Yesorno rowsep? ("left" | "right" | "center" | "justify" | "char") align? String char? String charoff? Secur
 ;
syntax Entry
        = 
...
syntax Entry_attlist
        = 
        String colname? String namest? String nameend? String spanname? String morerows? Yesorno colsep? Yesorno rowsep? ("left" | "right" | "center" | "justify" | "char") align? String char? String charoff? Yesorno rotate? ("top" | "middle" | "bottom") valign? Secur
 ;
...
syntax Sect1_attlist
        = 
        ("sect2" | "sect3" | "sect4" | "sect5") renderas? Label_attrib Status_attrib Common_attrib Sect1_role_attrib Local_sect1_attrib
 ;
...
syntax Sect2_attlist
        = 
        ("sect1" | "sect3" | "sect4" | "sect5") renderas? Label_attrib Status_attrib Common_attrib Sect2_role_attrib Local_sect2_attrib
 ;
...
syntax Sect3_attlist
        = 
        ("sect1" | "sect2" | "sect4" | "sect5") renderas? Label_attrib Status_attrib Common_attrib Sect3_role_attrib Local_sect3_attrib
 ;
...
syntax Sect4_attlist
        = 
        ("sect1" | "sect2" | "sect3" | "sect5") renderas? Label_attrib Status_attrib Common_attrib Sect4_role_attrib Local_sect4_attrib
 ;
...
syntax Sect5_attlist
        = 
        ("sect1" | "sect2" | "sect3" | "sect4") renderas? Label_attrib Status_attrib Common_attrib Sect5_role_attrib Local_sect5_attrib
 ;
...
syntax Article_attlist
        = 
        ("journalarticle" | "productsheet" | "whitepaper" | "techreport" | "specification" | "faq") class? String parentbook? Status_attrib Common_attrib Article_role_attrib Local_article_attrib
 ;
...
syntax Revisionflag_attrib
        = 
        ("changed" | "added" | "deleted" | "off") revisionflag?
 ;
...
syntax Graphics_attrib
        = 
        String entityref? String fileref? Notation_class format? String srccredit? String width? String contentwidth? String depth? String contentdepth? ("left" | "right" | "center") align? ("top" | "middle" | "bottom") valign? String scale? Yesorno_attvals scalefit? Local_graphics_attrib
 ;
...
syntax Keyaction_attrib
        = 
        ("click" | "double-click" | "press" | "seq" | "simul" | "other") action? String otheraction? Local_keyaction_attrib
 ;
syntax Label_attrib
        = 
        String label?
...
syntax Linespecific_attrib
        = 
        "linespecific" format? ("numbered" | "unnumbered") linenumbering?
 ;
...
syntax Qandaset_attlist
        = 
        ("qanda" | "number" | "none") defaultlabel? Common_attrib Qandaset_role_attrib Local_qandaset_attrib
 ;
...
syntax Step_attlist
        = 
        ("optional" | "required") performance? Common_attrib Step_role_attrib Local_step_attrib
 ;
...
syntax Substeps_attlist
        = 
        ("optional" | "required") performance? Common_attrib Substeps_role_attrib Local_substeps_attrib
 ;
...
syntax Bridgehead_attlist
        = 
        ("other" | "sect1" | "sect2" | "sect3" | "sect4" | "sect5") renderas? Common_attrib Bridgehead_role_attrib Local_bridgehead_attrib
 ;
...
syntax Itemizedlist_attlist
        = 
        ("normal" | "compact") spacing? Mark_attrib Common_attrib Itemizedlist_role_attrib Local_itemizedlist_attrib
 ;
...
syntax Orderedlist_attlist
        = 
        ("arabic" | "upperalpha" | "loweralpha" | "upperroman" | "lowerroman") numeration? ("inherit" | "ignore") inheritnum? ("continues" | "restarts") continuation? ("normal" | "compact") spacing? Common_attrib Orderedlist_role_attrib Local_orderedlist_attrib
 ;
...
syntax Simplelist_attlist
        = 
        String columns? ("inline" | "vert" | "horiz") type? Common_attrib Simplelist_role_attrib Local_simplelist_attrib
 ;
...
syntax Areaspec_attlist
        = 
        ("calspair" | "linecolumn" | "linerange" | "linecolumnpair" | "other") units? String otherunits? Common_attrib Areaspec_role_attrib Local_areaspec_attrib
 ;
...
syntax Area_attlist
        = 
        Label_attrib Linkends_attrib ("calspair" | "linecolumn" | "linerange" | "linecolumnpair" | "other") units? String otherunits? String coords Idreq_common_attrib Area_role_attrib Local_area_attrib
 ;
...
syntax Areaset_attlist
        = 
        Label_attrib ("calspair" | "linecolumn" | "linerange" | "linecolumnpair" | "other") units? String otherunits? String coords Idreq_common_attrib Areaset_role_attrib Local_areaset_attrib
 ;
...
syntax Literallayout_attlist
        = 
        Width_attrib Linespecific_attrib ("monospaced" | "normal") class? Common_attrib Literallayout_role_attrib Local_literallayout_attrib
 ;
...
syntax Objectdata_attrib
        = 
        String entityref? String fileref? Notation_class format? String srccredit? Local_objectdata_attrib
 ;
...
syntax Videodata_attlist
        = 
        String width? String contentwidth? String depth? String contentdepth? ("left" | "right" | "center") align? ("top" | "middle" | "bottom") valign? String scale? Yesorno_attvals scalefit? Objectdata_attrib Common_attrib Videodata_role_attrib Local_videodata_attrib
 ;
...
syntax Imagedata_attlist
        = 
        String width? String contentwidth? String depth? String contentdepth? ("left" | "right" | "center") align? ("top" | "middle" | "bottom") valign? String scale? Yesorno_attvals scalefit? Objectdata_attrib Common_attrib Imagedata_role_attrib Local_imagedata_attrib
 ;
...
syntax Informaltable_attlist
        = 
        ("top" | "bottom" | "topbot" | "all" | "sides" | "none") frame? Yesorno_attvals colsep? Yesorno_attvals rowsep? Common_table_attribs Tbl_table_att Local_informaltable_attrib
 ;
...
syntax Arg_attlist
        = 
        ("opt" | "req" | "plain") choice? ("norepeat" | "repeat") rep? Common_attrib Arg_role_attrib Local_arg_attrib
 ;
...
syntax Group_attlist
        = 
        ("opt" | "req" | "plain") choice? ("norepeat" | "repeat") rep? Common_attrib Group_role_attrib Local_group_attrib
 ;
...
syntax Classsynopsis_attlist
        = 
        String language? ("class" | "interface") class? Common_attrib Classsynopsis_role_attrib Local_classsynopsis_attrib
 ;
...
syntax Methodparam_attlist
        = 
        ("opt" | "req" | "plain") choice? ("norepeat" | "repeat") rep? Common_attrib Methodparam_role_attrib Local_methodparam_attrib
 ;
...
syntax Biblio_class_attrib
        = 
        ("uri" | "doi" | "isbn" | "issn" | "libraryofcongress" | "pubnumber" | "other") class? String otherclass?
 ;
...
syntax Bibliorelation_type_attrib
        = 
        ("isversionof" | "hasversion" | "isreplacedby" | "replaces" | "isrequiredby" | "requires" | "ispartof" | "haspart" | "isreferencedby" | "references" | "isformatof" | "hasformat" | "othertype" | Local_bibliorelation_types) type? String othertype?
 ;
...
syntax Bibliocoverage_attlist
        = 
        ("dcmipoint" | "iso3166" | "dcmibox" | "tgn" | "otherspatial") spatial? String otherspatial? ("dcmiperiod" | "w3c-dtf" | "othertemporal") temporal? String othertemporal? Common_attrib Bibliocoverage_role_attrib Local_bibliocoverage_attrib
 ;
...
syntax Modespec_attlist
        = 
        Notation_class application? Common_attrib Modespec_role_attrib Local_modespec_attrib
 ;
...
syntax Orgname_attlist
        = 
        Common_attrib ("corporation" | "nonprofit" | "consortium" | "informal" | "other") class? String otherclass? Orgname_role_attrib Local_orgname_attrib
 ;
...
syntax Productname_attlist
        = 
        ("service" | "trade" | "registered" | "copyright") class? Common_attrib Productname_role_attrib Local_productname_attrib
 ;
...
syntax Application_attlist
        = 
        ("hardware" | "software") class? Moreinfo_attrib Common_attrib Application_role_attrib Local_application_attrib
 ;
...
syntax Database_attlist
        = 
        ("name" | "table" | "field" | "key1" | "key2" | "record") class? Moreinfo_attrib Common_attrib Database_role_attrib Local_database_attrib
 ;
...
syntax Filename_attlist
        = 
        ("headerfile" | "partition" | "devicefile" | "libraryfile" | "directory" | "extension" | "symlink") class? String path? Moreinfo_attrib Common_attrib Filename_role_attrib Local_filename_attrib
 ;
...
syntax Constant_attlist
        = 
        "limit" class? Common_attrib Constant_role_attrib Local_constant_attrib
 ;
...
syntax Medialabel_attlist
        = 
        ("cartridge" | "cdrom" | "disk" | "tape") class? Common_attrib Medialabel_role_attrib Local_medialabel_attrib
 ;
...
syntax Parameter_attlist
        = 
        ("command" | "function" | "option") class? Moreinfo_attrib Common_attrib Parameter_role_attrib Local_parameter_attrib
 ;
...
syntax Replaceable_attlist
        = 
        ("command" | "function" | "option" | "parameter") class? Common_attrib Replaceable_role_attrib Local_replaceable_attrib
 ;
...
syntax Sgmltag_attlist
        = 
        ("attribute" | "attvalue" | "element" | "endtag" | "emptytag" | "genentity" | "numcharref" | "paramentity" | "pi" | "xmlpi" | "starttag" | "sgmlcomment") class? Common_attrib Sgmltag_role_attrib Local_sgmltag_attrib
 ;
...
syntax Symbol_attlist
        = 
        "limit" class? Common_attrib Symbol_role_attrib Local_symbol_attrib
 ;
...
syntax Systemitem_attlist
        = 
        ("constant" | "event" | "eventhandler" | "domainname" | "fqdomainname" | "ipaddress" | "netmask" | "etheraddress" | "groupname" | "library" | "macro" | "osname" | "filesystem" | "resource" | "systemname" | "username" | "newsgroup") class? Moreinfo_attrib Common_attrib Systemitem_role_attrib Local_systemitem_attrib
 ;
...
syntax Citetitle_attlist
        = 
        ("article" | "book" | "chapter" | "part" | "refentry" | "section" | "journal" | "series" | "set" | "manuscript") pubwork? Common_attrib Citetitle_role_attrib Local_citetitle_attrib
 ;
...
syntax Trademark_attlist
        = 
        ("service" | "trade" | "registered" | "copyright") class? Common_attrib Trademark_role_attrib Local_trademark_attrib
 ;
...
syntax Indexterm_attlist
        = 
        Pagenum_attrib ("all" | "global" | "local") scope? ("preferred" | "normal") significance? ("singular" | "startofrange" | "endofrange") class? String startref? String zone? Common_attrib Indexterm_role_attrib Local_indexterm_attrib
 ;
...
public void main()
{
	registerLanguage("Docbook_walsh", "ext", set(str input, loc org) {return parse(#set, input, org);});
