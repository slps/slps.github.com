...
syntax OperatorDeclaration
        ...
        | NamedOperator
 ;
syntax ArbitrarySort
        = 
        arbitrarysort: SortDeclaration_content
 ;
syntax ArbitraryOperator
        = 
        arbitraryoperator: OperatorDeclaration_content Sort input* Sort output
 ;
syntax Unparsed
        = 
        unparsed: Declaration_content AnyElement*
 ;
syntax Partition
        = 
...
public void main()
{
	registerLanguage("Pnml_highlevelnet", "ext", pnml.element(str input, loc org) {return parse(#pnml.element, input, org);});
