...
syntax SVG_clipPath
        = 
        clipPath: SVG_Description_class* (SVG_Animation_class | SVG_Use_class)* SVG_Shape_class? SVG_Core_attrib SVG_Conditional_attrib SVG_Style_attrib SVG_Text_attrib SVG_TextContent_attrib SVG_Font_attrib SVG_Paint_attrib SVG_Color_attrib SVG_Opacity_attrib SVG_Graphics_attrib SVG_Clip_attrib SVG_Mask_attrib SVG_Filter_attrib SVG_Cursor_attrib SVG_External_attrib SVG_TransformList_datatype transform? ("userSpaceOnUse" | "objectBoundingBox") clipPathUnits?
 ;
...
public void main()
{
	registerLanguage("Svg_furubayashi_basic", "ext", SVG.svg(str input, loc org) {return parse(#SVG.svg, input, org);});
