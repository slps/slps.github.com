...
syntax Meta_Reviewer
        = 
        Administrator assignedByAdministrator Bid adjustBid Paper readPaper Paper hasBeenAssigned Review writeReview ExternalReviewer assignExternalReviewer Reviewer invites_co-reviewers Reviewer invited_by Thing has_a_review_reference_or_expertise+ Review writes_review PersonalReviewHistory hasReviewHistory DoubleBlindReview executes
 ;
syntax Decision
        = Acceptance
        | Rejection
...
syntax AuthorNotReviewer
        = 
        Paper submitPaper Paper writePaper Contribution writes Article writes_article Article assigns_article_to_conference Paper hasRelatedPaper Thing conflictsWith+ ActivitySubmissionForm isAuthorOf Thing conducts
 ;
syntax SubjectArea
        = 
        ()
...
syntax Chairman
        ...
        | AssociatedChair
        | ProgramCommitteeChair
        | String hasMail String worksForCompany Document hasConflictOfInterest String email Thing inverse_of_add+ Thing execute+ Inforamtion get Document use Account register Thing modify+ Event take_part_in Thing remove+ Person add Person added_by Conference_document contributes String has_an_email String has_the_first_name EEnum has_gender String has_the_last_name Organization employedBy String hasHomePage String hasSurname String hasFax String hasFirstName String hasPhone String hasEmail ConferenceEvent attendeeAt Conference isMemberOf String hasFirstName String hasBiography String hasLastName Document authorOf Item prepare Presenter_city occupy+ Thing is_present_in+ Item write Item obtain Item send Thing speak_in+ Money pay Item sign Time is_present Thing give+ Item need Conference memberOfConference
 ;
...
syntax Event_Creation
        = 
        Time is_held_before Thing is_held_in Time is_held_after DateTime is_dated_on Topic hasTopic Integer expectedAttendance Conference isPartOf Thing has_result+ Person sent_by
 ;
