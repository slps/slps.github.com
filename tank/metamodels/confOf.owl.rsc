...
syntax Person
        ...
        | Chairman
        | Administrator
        | Thing inverse_of_add+ Thing execute+ Inforamtion get Document use Account register Thing modify+ Event take_part_in Thing remove+ Person add Activity send Person added_by Conference_document contributes String has_an_email String has_the_first_name EEnum has_gender String has_the_last_name Organization employedBy String hasHomePage String hasSurname String hasFax String hasFirstName String hasPhone String hasEmail Document hasConflictOfInterest String email
 ;
syntax Preference
        = 
        ()
...
syntax AuthorNotReviewer
        = 
        Contribution writes Paper submitPaper Paper writePaper
 ;
syntax SubjectArea
        = 
        ()
...
syntax Chairman
        ...
        | AssociatedChair
        | ProgramCommitteeChair
        | Thing inverse_of_add+ Thing execute+ Inforamtion get Document use Account register Thing modify+ Event take_part_in Thing remove+ Person add Activity send Person added_by Conference_document contributes String has_an_email String has_the_first_name EEnum has_gender String has_the_last_name Organization employedBy String hasHomePage String hasSurname String hasFax String hasFirstName String hasPhone String hasEmail Document hasConflictOfInterest String email Conference memberOfConference
 ;
...
syntax Event
        ...
        | Working_event
        | Event_Tracks conists_of Approval_Email confirmed_by Event_Setup defined_by Administrator approved_by String starts_on String ends_on
 ;
syntax Account
        = 
        registred_by: Person
...
syntax Tutorial
        = 
        Topic has_a_track-workshop-tutorial_topic Conference_volume is_part_of_conference_volumes Track_workshop_chair has_a_track-workshop-tutorial_chair Topic hasTopic Administrative_event hasAdministrativeEvent
 ;
...
syntax Accepted_Paper
        = 
        Integer full_paper_size Human has_author
 ;
syntax Paper
        = Accepted_Paper
        | Rejected_Paper
...
syntax Review
        = 
        Classification gives_classification Activity is_created_in
 ;
