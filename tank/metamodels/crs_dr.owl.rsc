...
syntax Review
        = Meta_Review
        | Reviewed_contribution reviews Reviewer writtenBy
 ;
syntax Paper
        = PaperAbstract
        | PaperFullVersion
...
syntax Conference
        = 
        Program has_program Phase_of_conference is_in_phase
 ;
...
syntax Author
        = 
        Article writes_article Article assigns_article_to_conference
 ;
syntax Person
        = Author
        | Chair
...
syntax Pc_meeting
        = 
        DateTime has_startdate DateTime has_enddate
 ;
syntax Event
        = Pc_meeting
        | Session
